                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 p-l-20">
                                ...
                                <p v-if="current_selected_sub_kegiatan!=null"><strong>Dana Tersedia:</strong> @{{ current_selected_sub_kegiatan | get_sub_kegiatan('dana_tersedia') | money }}</p>
                                        ...
                                        <div data-role="content">
                                            <table class="table table-striped">
                                                ...
                                                <tr v-for="(data,key) in rekening_pengajuan">
                                                    <td>@{{ data.sub_kegiatan_id | get_sub_kegiatan('nama') }}</td>
                                                    <td>@{{ data.uraian }}</td>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <select2 placeholder="Pejabat Pelaksana Teknis Kegiatan" v-model="pejabat_pelaksana_teknis_kegiatan_id">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select2 v-model="pejabat_pengadaan_barang_dan_jasa_id" placeholder="Pejabat Pengadaan Barang Dan Jasa" v-model="pejabat_pelaksana_teknis_kegiatan_id">
                                    @foreach($pegawai as $single)
                                        <option value="{{$single->id}}">{{$single->nama}}</option>
                                    @endforeach
                                </select2>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select2 placeholder="Pejabat Kuasa Pengguna Anggaran" v-model="pejabat_kuasa_pengguna_anggaran_id">
                                    <option value=""></option>
                                    @foreach($pegawai as $single)
                                        <option value="{{$single->id}}">{{$single->nama}}</option>
                                    @endforeach
        ...
        data = new Vue({
            ...
            methods:{
                tambah_uraian:function(){
                    this.uraian.push({uraian:'',jumlah:'',sub_kegiatan_id:this.current_selected_sub_kegiatan});
                },
