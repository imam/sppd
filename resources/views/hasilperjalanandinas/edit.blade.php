...
@section('content')
    ...
    @endif
    <form action="{{route('hasilperjalanandinas.update',['id'=> $hasilperjalanandinas->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div id="content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body">
                    <textarea name="hasil" class="summernote" id="hasil">{!! $hasilperjalanandinas->hasil !!}</textarea>
                    @if($hasilperjalanandinas->file)
                        <h5>Abaikan mengunggah file jika anda tidak ingin mengganti file yang telah terunggah sebelumnya</h5>
                    @endif
        ...
        data = new Vue({
            ...
            mounted:function(){
                if(oldinput){
                    ...
                    this.kegiatan_id = current.perjalanan_dinas.kegiatan_id;
                    this.perjalanan_dinas_id = current.perjalanan_dinas_id;
                }
            },
            watch:{
                                ...
                                .then(function(response){
                                    ...
                                    if(this.first_mount){
                                        if(oldinput){
                                            ...
                                            this.sub_kegiatan_id = current.perjalanan_dinas.sub_kegiatan_id;
                                            this.first_mount = false;
                                        }
                                    }
