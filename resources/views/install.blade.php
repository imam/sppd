    ...
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        <div class="panel">
            <div class="panel-body">
                <div class="brand">
                    <h2 class="brand-text font-size-18">First Site Administrator Account</h2>
                    <h5>Buat akun administrator pertama untuk situs SPPD</h5>
                </div>
                <form method="post" action="firstsignup">
                    {{csrf_field()}}
                    @if (count($errors) > 0)
