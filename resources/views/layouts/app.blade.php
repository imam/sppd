                ...
                <ul class="site-menu" data-plugin="menu">
                    ...
                    <li class="site-menu-item">
                        <a href="#">
                            ...
                            <span class="site-menu-title">Profil Saya</span>
                        </a>
                    </li>
                    <li class="site-menu-category">DPPA</li>
                    <li class="site-menu-item has-sub">
                        <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="/dppa/program/">
                                        <span class="site-menu-title">Daftar Program</span>
                                    </a>

                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="kepo">
                                        <span class="site-menu-title">Tambah Program</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="kepo">
                                        <span class="site-menu-title">Impor Program</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="kepo">
                                        <span class="site-menu-title">Ekspor Program</span>
                                    </a>
                                </li>
                            </ul>
                        </a>
                    </li>
                    <li class="site-menu-category">Kepegawaian</li>
                    <li class="site-menu-item has-sub">
                        <a href="javascript:void(0)">
                            ...
                            <ul class="site-menu-sub">
                                ...
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="kepo">
                                        <span class="site-menu-title">Ekspor Pegawai</span>
                                    </a>
                                </li>
                            </ul>
                        </a>
                    </li>
                    <li class="site-menu-category">Administrasi Situs</li>
                    <li class="site-menu-item has-sub">
                        <a href="javascript:void(0)">
