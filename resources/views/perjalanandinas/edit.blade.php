            ...
            <div class="col-lg-6">
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row input-daterange m-t-10 text-xs-left" data-plugin="datepicker"
                             data-start-date="now" data-format="dd/mm/yyyy">
                            <div class="col-lg-6">
    ...
    <script>
        ...
        data = new Vue({
            ...
            data:{
                ...
                request: null,
                jenis_perjalanan: perjalanan_dinas.jenis_perjalanan,
                kegiatan_loading: false,
                show_sub_kegiatan: false,
                sub_kegiatan_id: perjalanan_dinas.sub_kegiatan_id,
                request: [],
                kegiatan_id: perjalanan_dinas.kegiatan_id,
                tempat_berangkat: perjalanan_dinas.tempat_berangkat,
                submitting: false,
                tempat_tujuan: perjalanan_dinas.tempat_tujuan,
                tanggal_berangkat: moment(perjalanan_dinas.tanggal_berangkat).format('DD/MM/YYYY'),
                tanggal_pulang: moment(perjalanan_dinas.tanggal_pulang).format('DD/MM/YYYY'),
                referensi_perjalanan: perjalanan_dinas.referensi_perjalanan,
                nomor_referensi: perjalanan_dinas.nomor_referensi,
                alat_angkutan_yang_digunakan: perjalanan_dinas.alat_angkutan_yang_digunakan,
                tanggal_referensi: moment(perjalanan_dinas.tanggal_referensi).format('DD/MM/YYYY'),
                tingkat_biaya_perjalanan_dinas: perjalanan_dinas.tingkat_biaya_perjalanan_dinas,
                maksud_perjalanan: perjalanan_dinas.maksud_perjalanan,
                keterangan_lain_lain:perjalanan_dinas.keterangan_lain_lain,
                pejabat_pelaksana_teknis_kegiatan:perjalanan_dinas.pejabat_pelaksana_teknis_kegiatan,
                pejabat_pengadaan_barang_dan_jasa:perjalanan_dinas.pejabat_pengadaan_barang_dan_jasa,
                pejabat_kuasa_pengguna_anggaran:perjalanan_dinas.pejabat_kuasa_pengguna_anggaran,
                errors: null
            },
            mounted:function(){
            ...
            methods:{
                submit:function(){
                    ...
                    data.errors = null;
                    axios.put('/perjalanandinas/'+perjalanan_dinas.id,this.request)
                            .then( function(response){
